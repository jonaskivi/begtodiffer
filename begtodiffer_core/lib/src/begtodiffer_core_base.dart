...
Future<ProcessResult> _runGit(String repo, List<String> args) async {
  print('[begtodiffer_core] RUN git ${args.join(' ')} (cwd: $repo)');
  ...
  print(
      '[begtodiffer_core] EXIT ${result.exitCode} for git ${args.join(' ')} (cwd: $repo)');
  if (stdoutStr.isNotEmpty) {
    print('[begtodiffer_core] STDOUT:\n$stdoutStr');
  }
  if (stderrStr.isNotEmpty) {
    print('[begtodiffer_core] STDERR:\n$stderrStr');
  }
  return result;
}
